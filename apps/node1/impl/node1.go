...
func (i *impl) UploadDockerCompressInstallFile(context.Context) error {
	_, err := i.c.Node1.UploadFile(i.c.Docker.CompressInstallFile, i.c.Docker.DockerCompressInstallFilePath())
	if err != nil {
		return err
	}
...
func (i *impl) UploadContainerdCompressInstallFile(context.Context) error {
	_, err := i.c.Node1.UploadFile(i.c.Containerd.CompressInstallFile, i.c.Containerd.ContainerdCompressInstallFilePath())
	if err != nil {
		return err
	}
