...
func (i *impl) UploadDockerInstallFile(context.Context) error {
	_, err := i.c.Node1.UploadFile(i.c.Docker.LimitsFile, i.c.Docker.LimitsFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Docker.LimitsFile)
	_, err = i.c.Node1.UploadFile(i.c.Docker.SysctlFile, i.c.Docker.SysctlFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Docker.SysctlFile)
	_, err = i.c.Node1.UploadFile(i.c.Docker.DockerBinaryFile, i.c.Docker.DockerBinaryFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Docker.DockerBinaryFile)
	_, err = i.c.Node1.UploadFile(i.c.Docker.DockerDaemonFile, i.c.Docker.DockerDaemonFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Docker.DockerDaemonFile)
	_, err = i.c.Node1.UploadFile(i.c.Docker.ContainerdServiceFile, i.c.Docker.ContainerdServiceFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Docker.ContainerdServiceFile)
	_, err = i.c.Node1.UploadFile(i.c.Docker.DockerServiceFile, i.c.Docker.DockerServiceFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Docker.DockerServiceFile)
	_, err = i.c.Node1.UploadFile(i.c.Docker.DockerSocketFile, i.c.Docker.DockerSocketFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Docker.DockerSocketFile)
	_, err = i.c.Node1.UploadFile(i.c.Docker.DockerComposeFile, i.c.Docker.DockerComposeFilePath())
	if err != nil {
		return err
	}
...
func (i *impl) UbuntuDockerInstall(ctx context.Context) error {
	...
	res, err := i.c.Node1.RunShell(cmd)
	if err != nil {
		return err
	}
...
func (i *impl) UploadContainerdInstallFile(context.Context) error {
	...
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Docker.ContainerdServiceFile)
	_, err = i.c.Node1.UploadFile(i.c.Containerd.ContainerdFile, i.c.Containerd.ContainerdFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Containerd.ContainerdFile)
	_, err = i.c.Node1.UploadFile(i.c.Containerd.ContainerdConfigFile, i.c.Containerd.ContainerdConfigFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Containerd.ContainerdConfigFile)
	_, err = i.c.Node1.UploadFile(i.c.Containerd.NerdctlFile, i.c.Containerd.NerdctlFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Containerd.NerdctlFile)
	_, err = i.c.Node1.UploadFile(i.c.Containerd.NerdctlConfigFile, i.c.Containerd.NerdctlConfigFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Containerd.NerdctlConfigFile)
	_, err = i.c.Node1.UploadFile(i.c.Containerd.CniFile, i.c.Containerd.CniFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Containerd.CniFile)
	_, err = i.c.Node1.UploadFile(i.c.Containerd.RuncFile, i.c.Containerd.RuncFilePath())
	if err != nil {
		return err
	}
	logger.L().Info().Msgf("%s文件上传成功!", i.c.Containerd.RuncFile)
	_, err = i.c.Node1.UploadFile(i.c.Containerd.IpvsModuleFile, i.c.Containerd.IpvsModuleFilePath())
	if err != nil {
		return err
	}
...
func (i *impl) JoinK8s(ctx context.Context) error {
	...
	logger.L().Info().Msgf("%s加入k8s集群完成!", i.c.Node1.SysHost)
	return nil
}
