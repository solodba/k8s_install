...
// 创建SSH连接
func (m *Node2) CreateSSHConn() (*ssh.Client, error) {
...
// 创建sftp连接
func (m *Node2) CreateSftpConn() (*sftp.Client, error) {
...
// 创建SSH会话用于执行shell命令
func (m *Node2) RunShell(shell string) (string, error) {
...
// 创建上传文件的方法
func (m *Node2) UploadFile(srcFile, dstFile string) (string, error) {
...
// 创建下载文件的方法
func (s *Node2) DownloadFile(srcFile, dstFile string) (string, error) {
